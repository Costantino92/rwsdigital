import style from "../styles/LatestTrends.module.css";
    ...
    <div className={style.card} style={{ width: "100%" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          ...
          >
            <div>
              <h4 style={{ margin: "0", padding: "0" }}> Top Sales</h4>
              <span style={{ color: "grey" }}>PitStop Emails</span>
            </div>
            <div>
              <span className={style.span}>+82$</span>
            </div>
        ...
        <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
          ...
          >
            <div>
              <h4 style={{ margin: "0", padding: "0" }}> Top Engagement</h4>
              <span style={{ color: "grey" }}>KT.com</span>
            </div>
            <div>
              <span className={style.span}>+82$</span>
            </div>
